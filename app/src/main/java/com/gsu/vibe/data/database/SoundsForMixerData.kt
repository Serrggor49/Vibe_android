...
object SoundsForMixerData {
    ...
    fun getAnimals() : ArrayList<MixerSoundModel>{
        return arrayListOf(birdsSound, ladybugSound, birds2Sound, dolphinSound, catSound)
    }

    fun getNature() : ArrayList<MixerSoundModel>{
        return arrayListOf(rainSound, thunderstormSound, thunderSound, waterflowSound, seaSound, blizzardSound, riverSound)
    }

    fun getInstrument() : ArrayList<MixerSoundModel>{
        return arrayListOf(harpSound, flautaSound, guitarSound, pianoSound, tibetSound)
    }

    val birdsSound = MixerSoundModel(name = "птицы", backimage = R.drawable.mixer_ladybug, sound = R.raw.bird_test)
    val ladybugSound = MixerSoundModel(name = "насекомые", backimage = R.drawable.mixer_birds, sound = R.raw.bird_test)
    ...
    val rainSound = MixerSoundModel(name = "дождь", backimage = R.drawable.mixer_rain, sound = R.raw.bird_test)
    val thunderstormSound = MixerSoundModel(name = "шторм", backimage = R.drawable.mixer_thunderstorm, sound = R.raw.bird_test)
    ...
    val harpSound = MixerSoundModel(name = "арфа", backimage = R.drawable.mixer_harp, sound = R.raw.bird_test)
